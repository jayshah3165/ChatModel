...
public class RemoveMemberFromGroupAPi {
    private final static String API = Const.REMOVE_MEMBER_FROM_GROUP_API;
    ...
    public RemoveMemberFromGroupAPi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String group_id,String member_id,String conversation_id) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),group_id,member_id,conversation_id,
