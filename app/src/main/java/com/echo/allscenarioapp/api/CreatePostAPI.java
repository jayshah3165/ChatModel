...
public class CreatePostAPI {
    ...
    private final static String API = Const.CREATE_POST_API;
    private ResponseListener responseListener = null;
    private Context context = null;
    private static IRequestData iRequestData = null;
    public String mesg = "";

    public CreatePostAPI(Context _context, ResponseListener _responseListener) {
    ...
    private interface IRequestData {
        ...
        Call<ResponseModelService> getResponseData(
                ...
                @Field("feed_type") String feed_type,//1=Text, 2=Image, 3=Video, 4=Checking 5=Audio
    ...
    public Void execute(String feed_type,String message,String media_url,String thumb_url,String latitude,String longitude,String location) {
        try {
            Call<ResponseModelService> call = iRequestData.getResponseData(Pref.getStringValue(context, Const.PREF_USERID, ""),feed_type,message,media_url,thumb_url,latitude,longitude,location,
