...
public class DeleteGroupAPi {
    private final static String API = Const.DELETE_GROUP_API;
    ...
    public DeleteGroupAPi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String group_id) {
        try {
            ...
            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),group_id,
