...
public class OnlineChatAPI {
    ...
    private final static String API = Const.ONLINE_CHAT_API;
    private ResponseListener responseListener = null;
    private Context context = null;
    private static IRequestData iRequestData = null;

    public OnlineChatAPI(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String is_online) {
        try {
            Call<ResponseModelService> call = iRequestData.getResponseData(Pref.getStringValue(context, Const.PREF_USERID, ""),is_online,Const.DEVICE_TYPE, Pref.getStringValue(context, Const.PREF_GCMTOKEN, ""), Pref.getStringValue(context, Const.PREF_LANGUAGE, Const.EN));
