...
public class DeleteCommentAPi {
    private final static String API = Const.DELETE_COMMENT_API;
    ...
    public DeleteCommentAPi(Context _context, ResponseListener _responseListener) {
    ...
    private interface IRequestData {
        ...
        Call<ResponseModelService> getResponseData(
                ...
                @Field("type") String type  ,// 1=delete comment 2=spam comment
    ...
    public Void execute(String post_id,String comment_id,String type) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),post_id,comment_id,type,
