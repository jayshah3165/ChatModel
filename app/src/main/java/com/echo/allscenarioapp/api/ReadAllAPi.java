...
public class ReadAllAPi {
    private final static String API = Const.READ_ALL_API;
    ...
    public ReadAllAPi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String conversation_id) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),conversation_id,
