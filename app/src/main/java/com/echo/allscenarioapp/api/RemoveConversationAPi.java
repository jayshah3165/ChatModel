...
public class RemoveConversationAPi {
    private final static String API = Const.REMOVE_CONVERSATION_API;
    ...
    public RemoveConversationAPi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String friend_id,String conversation_id,String is_group) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),friend_id,conversation_id,is_group,
