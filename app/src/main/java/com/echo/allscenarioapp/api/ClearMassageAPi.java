...
public class ClearMassageAPi {
    private final static String API = Const.DELETE_CONVERSATION_API;
    ...
    public ClearMassageAPi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String conversation_id,String friend_id,String is_group) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),conversation_id,friend_id,is_group,
