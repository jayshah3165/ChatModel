...
public class DeletePostAPi {
    private final static String API = Const.DELETE_POST_API;
    ...
    public DeletePostAPi(Context _context, ResponseListener _responseListener) {
    ...
    private interface IRequestData {
        ...
        Call<ResponseModelService> getResponseData(
                ...
                @Field("type") String type,//  1= delete post 2= spam post
    ...
    public Void execute(String post_id,String type) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData(Pref.getStringValue(context, Const.PREF_USERID, ""),post_id,type,
