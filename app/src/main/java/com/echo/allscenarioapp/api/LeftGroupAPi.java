...
public class LeftGroupAPi {
    private final static String API = Const.LEFT_GROUP_API;
    ...
    public LeftGroupAPi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute(String group_id,String conversation_id) {
        try {

            Call<ResponseModelService> call = iRequestData.getResponseData( Pref.getStringValue(context, Const.PREF_USERID, ""),group_id,conversation_id,
