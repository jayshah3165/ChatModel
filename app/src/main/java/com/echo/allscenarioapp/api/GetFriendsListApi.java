...
public class GetFriendsListApi {

    private final static String API = Const.GET_FRIENDS_LIST_API;
    private ResponseListener responseListener = null;
    private Context context = null;
    private static IRequestData iRequestData = null;
    public ArrayList<FriendsListModel> objList = null;

    public GetFriendsListApi(Context _context, ResponseListener _responseListener) {
    ...
    public Void execute() {
       ...
       try {
            ...
            Call<ResponseModel<FriendsListModel>> call = iRequestData.getResponseData(Pref.getStringValue(context, Const.PREF_USERID,""), Const.DEVICE_TYPE, Pref.getStringValue(context, Const.PREF_GCMTOKEN,""), Pref.getStringValue(context, Const.PREF_LANGUAGE, "EN"));
