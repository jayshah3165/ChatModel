...
public class GroupFriendsListAdapter extends RecyclerView.Adapter<GroupFriendsListAdapter.MyViewHolder> {
    ...
    public GroupFriendsListAdapter(Context context, View.OnClickListener clickListener) {
    ...
    /*  public String getCheckIDs() {
          String strIDs = null;
          strIDs = chkIDs.toString();
          Utils.print("check Adprter-----------------------"+chkIDs.size());
          return strIDs;
      }*/
    @Override
