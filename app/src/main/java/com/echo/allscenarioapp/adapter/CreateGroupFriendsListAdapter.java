...
public class CreateGroupFriendsListAdapter extends RecyclerView.Adapter<CreateGroupFriendsListAdapter.MyViewHolder> {
    ...
    public CreateGroupFriendsListAdapter(Context context, View.OnClickListener clickListener) {
